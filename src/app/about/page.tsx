          ...
          <Card>
            <CardContent className="space-y-4 text-body text-muted-foreground pt-6">
              ...
              <blockquote className="space-y-3 rounded-xl bg-muted/50 text-foreground/80">
                <p>"Harga jual gua 100ribu, HPP-nya 50ribu. Tapi apa itu udah nutup biaya admin marketplace, biaya packaging, sama payment fee? Jangan-jangan untung bersih gua cuma 10 ribu."</p>
