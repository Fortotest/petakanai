...
export default function AboutPage() {
  return (
    <>
      <Header />
      <main className="container mx-auto max-w-3xl px-4 pt-8 pb-6">
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="space-y-4 text-body text-muted-foreground pt-6">
              ...
              <p>
                Gua takut modal dan waktu kebuang sia-sia karena salah hitung di detail or perintilan kecil. Keresahan-keresahan itu yang jadi Petakan.ai tercipta. dan Petakan.ai ini bukan alat yang rumit. Menurut gua sendiri sangat mudah untuk memberi jawaban pasti atas pertanyaan-pertanyaan tadi, sebelum kamu buang modal, waktu, sepeser pun.
              </p>
            </CardContent>
          </Card>
